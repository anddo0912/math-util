 ...
 * @author LamHung
 */
//câu lệnh này của JUnit báo hiệu rằng sẽ cần loop quá tập data để
//lấy các cặp data input/expected nhồi vào hàm test
...
public class MathUtilDDTTest {
    ...
    @Parameterized.Parameters //JUnit sẽ ngầm chạy loop qua từng dòng của mảng
                              //để lấy ra đc cặp data tương ứng
    ...
    @Parameterized.Parameter(value = 0) //value = 0 là map với mẳng data
    public int n; //biến map với value của cột 0
